...
const UserModal = () => {
  ...
  return (
    <>
      <div className="lg:flex flex items-center" onClick={onOpen} >
      <Avatar
              isBordered
              className="mr-2"
              color="default"
      ...
      >
        <ModalContent>
              ...
              <Card style={{ overflow: "scroll",maxHeight:"99vh", position:"relative"}}>
                <CardBody >
                ...
                <Button
                  isIconOnly
                  onPress={onClose}
                  style={{ position: "absolute", left: "20px", top:"28px",zIndex:100 }}
                  variant="flat"
                >
                  <CloseIcon/>
                </Button>
