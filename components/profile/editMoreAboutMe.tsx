...
import {Modal, ModalContent,ModalFooter , DatePicker, Input, Autocomplete, ModalHeader, AutocompleteItem, Avatar, Button, useDisclosure, ModalBody} from "@nextui-org/react";
...
const EditMoreAboutMe =() => {
  ...
  return (
    <>
      ...
      >
        <ModalContent>
          <ModalHeader className="flex flex-col gap-1">Edit more about me</ModalHeader>
          ...
          <ModalBody>
                ...
                <Select
                    ...
                    className="w-full"
                    >
                    {(RealationStatus) => <SelectItem>{RealationStatus.label}</SelectItem>}
                </Select>
                ...
                <Select
                    ...
                    className="w-full"
                    >
                    {(SexualityStatus) => <SelectItem>{SexualityStatus.label}</SelectItem>}
                </Select>
