...
const HeartEyesImoji = () =>  {
    return <svg onClick={heartConfetti} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
    <defs>
      <style
...
const NotLikeImoji = () => {
    return <svg onClick={sadConfetti} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
    <defs>
      <style
        dangerouslySetInnerHTML={{
          __html: ".cls-3{fill:#f6fafd}.cls-4{fill:#141e21}.cls-7{fill:#fbb40a}"
        }}
      />
    </defs>
...
export {HeartEyesImoji,NotLikeImoji}