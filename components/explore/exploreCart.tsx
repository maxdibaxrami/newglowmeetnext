...
const ExploreCard = ({ profileData }) => {
  ...
  return (
    <Card style={theme.theme==="light"?{ overflow: "scroll",boxShadow:"unset", maxHeight: "100vh",backgroundColor:"#ebebeb",marginTop:"4rem" }:{ overflow: "scroll", maxHeight: "100vh",marginTop:"4rem"}}>
      <CardBody>
